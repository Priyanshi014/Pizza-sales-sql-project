...
Turning raw sales data into actionable business insights using SQL

🚀 Project Overview

This project focuses on analyzing a real-world Pizza Sales dataset using SQL to uncover meaningful business insights. The goal was to evaluate revenue performance, understand customer ordering behavior, identify top-selling products, and analyze sales trends over time.
...
✔ Hour-wise order analysis (peak hours detection)
...
🔹 Analyzed revenue growth using cumulative trends
...
⏰ Peak Order Hours: Evening (20–21 hrs)
